...
sun = Body(1.9885e30, np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 0.0]))
earth = Body(5.972e24, np.array([1.495e11, 0.0, 0.0]), np.array([0.0, 29.78e3, 0.0]), np.array([0.0, 0.0, 0.0]))
moon = Body(7.35e22, np.array([1.496e11, 3.844e8, 0.0]), np.array([1022.0, 29780.0, 0.0]), np.array([0.0, 0.0, 0.0]))
...
def euler():
    data = Simulator(EulerIntegrator()).run([sun, earth, moon])
    
    visualizePositions(data, ["Sol", "Terra", "Lua"])
euler()